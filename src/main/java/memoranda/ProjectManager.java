...
//            _root.appendChild(new Comment("This is JNotes 2 data file. Do not modify."));
    ...
    //methods getActiveProjects and getActiveProjectsNumber are nearly identical
    //the code can be refactored to avoid code duplication by having one method call the
    //other
